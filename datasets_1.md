...
* `"1024"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 1024 x 1024 resolution

* `"512"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 512 x 512 resolution

* `"256"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 256 x 256 resolution

* `"128"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 128 x 128 resolution

* `"64"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 64 x 64 resolution

* `"32"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 32 x 32 resolution

* `"16"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 16 x 16 resolution

* `"8"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 8 x 8 resolution

* `"4"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 4 x 4 resolution

* `"2"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 2 x 2 resolution

* `"1"` (`v0.1.0`) (`Size: 0`): CelebaHQ images in 1 x 1 resolution
...
* `"classroom"` (`v0.1.1`) (`Size: 3285377283`): Classroom images.

* `"bedroom"` (`v0.1.1`) (`Size: 45927408341`): Bedroom images.
...
* `"plain_text"` (`v0.0.1`) (`Size: 84125825`): Plain text

* `"bytes"` (`v0.0.1`) (`Size: 84125825`): Uses byte-level text encoding with `tfds.features.text.ByteTextEncoder`

* `"subwords8k"` (`v0.0.1`) (`Size: 84125825`): Uses `tfds.features.text.SubwordTextEncoder` with 8k vocab size

* `"subwords32k"` (`v0.0.1`) (`Size: 84125825`): Uses `tfds.features.text.SubwordTextEncoder` with 32k vocab size
...
* `"plain_text"` (`v0.0.1`) (`Size: 1792209805`): Plain text

* `"bytes"` (`v0.0.1`) (`Size: 1792209805`): Uses byte-level text encoding with `tfds.features.text.ByteTextEncoder`

* `"subwords8k"` (`v0.0.2`) (`Size: 0`): Uses `tfds.features.text.SubwordTextEncoder` with 8k vocab size

* `"subwords32k"` (`v0.0.2`) (`Size: 0`): Uses `tfds.features.text.SubwordTextEncoder` with 32k vocab size
...
* `"plain_text"` (`v0.0.1`) (`Size: 0`): Plain text
...
* `"plain_text"` (`v0.0.1`) (`Size: 35142551`): Plain text

* `"bytes"` (`v0.0.1`) (`Size: 35142551`): Uses byte-level text encoding with `tfds.features.text.ByteTextEncoder`

* `"subwords8k"` (`v0.0.1`) (`Size: 35142551`): Uses `tfds.features.text.SubwordTextEncoder` with 8k vocab size

* `"subwords32k"` (`v0.0.2`) (`Size: 35142551`): Uses `tfds.features.text.SubwordTextEncoder` with 32k vocab size
...
* `"neen_plain_text"` (`v0.0.2`) (`Size: 0`): Translation dataset from ne to en, uses encoder plain_text.
...
* `"sien_plain_text"` (`v0.0.2`) (`Size: 0`): Translation dataset from si to en, uses encoder plain_text.
...
* `"ende_plain_text_t2t"` (`v0.0.2`) (`Size: 0`): Translation dataset from en to de, uses encoder plain_text. It uses the following data files (see the code for exact contents): {"dev": ["wmt17_newstest13"], "train": ["wmt18_news_commentary_ende", "wmt13_commoncrawl_ende", "wmt13_europarl_ende"]}.

* `"ende_subwords8k_t2t"` (`v0.0.2`) (`Size: 0`): Translation dataset from en to de, uses encoder subwords8k. It uses the following data files (see the code for exact contents): {"dev": ["wmt17_newstest13"], "train": ["wmt18_news_commentary_ende", "wmt13_commoncrawl_ende", "wmt13_europarl_ende"]}.
...
* `"enfr_plain_text_t2t_small"` (`v0.0.2`) (`Size: 0`): Translation dataset from en to fr, uses encoder plain_text. It uses the following data files (see the code for exact contents): {"dev": ["opennmt_1M_enfr_valid"], "train": ["opennmt_1M_enfr_train"]}.

* `"enfr_subwords8k_t2t_small"` (`v0.0.2`) (`Size: 0`): Translation dataset from en to fr, uses encoder subwords8k. It uses the following data files (see the code for exact contents): {"dev": ["opennmt_1M_enfr_valid"], "train": ["opennmt_1M_enfr_train"]}.

* `"enfr_plain_text_t2t_large"` (`v0.0.2`) (`Size: 0`): Translation dataset from en to fr, uses encoder plain_text. It uses the following data files (see the code for exact contents): {"dev": ["wmt17_newstest13"], "train": ["wmt13_commoncrawl_enfr", "wmt13_europarl_enfr", "wmt14_news_commentary_enfr", "wmt13_undoc_enfr"]}.

* `"enfr_subwords8k_t2t_large"` (`v0.0.2`) (`Size: 0`): Translation dataset from en to fr, uses encoder subwords8k. It uses the following data files (see the code for exact contents): {"dev": ["wmt17_newstest13"], "train": ["wmt13_commoncrawl_enfr", "wmt13_europarl_enfr", "wmt14_news_commentary_enfr", "wmt13_undoc_enfr"]}.
...
* `"brawl_64"` (`v0.1.2`) (`Size: 6876254915`): Brawl map with 64x64 resolution.

* `"brawl_128"` (`v0.1.2`) (`Size: 22287001316`): Brawl map with 128x128 resolution.

* `"collect_mineral_shards_64"` (`v0.1.2`) (`Size: 8412465948`): CollectMineralShards map with 64x64 resolution.

* `"collect_mineral_shards_128"` (`v0.1.2`) (`Size: 26663222422`): CollectMineralShards map with 128x128 resolution.

* `"move_unit_to_border_64"` (`v0.1.2`) (`Size: 1905731818`): MoveUnitToBorder map with 64x64 resolution.

* `"move_unit_to_border_128"` (`v0.1.2`) (`Size: 6178543049`): MoveUnitToBorder map with 128x128 resolution.

* `"road_trip_with_medivac_64"` (`v0.1.2`) (`Size: 2659123150`): RoadTripWithMedivac map with 64x64 resolution.

* `"road_trip_with_medivac_128"` (`v0.1.2`) (`Size: 8370660351`): RoadTripWithMedivac map with 128x128 resolution.
